...
public class InterfazCalculadora extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        octagonal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                octagonalActionPerformed(evt);
            }
        });

        hexagonal.setText("HEX");
        hexagonal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                hexagonalActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(hexagonal, javax.swing.GroupLayout.DEFAULT_SIZE, 80, Short.MAX_VALUE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addComponent(opborrar, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(opigual, javax.swing.GroupLayout.DEFAULT_SIZE, 84, Short.MAX_VALUE))))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(num4)
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(opsumar, javax.swing.GroupLayout.DEFAULT_SIZE, 80, Short.MAX_VALUE)
                            .addComponent(opmultiplicar, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(Pantalla2, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void opmultiplicarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_opmultiplicarActionPerformed
        ...
        op.multiplicacion(Pantalla.getText());
        Pantalla.setText("");
    ...
    private void opigualActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_opigualActionPerformed
        // TODO add your handling code here:
        Pantalla.setText(""+Integer.toString(op.resultadoOperacion(Pantalla.getText()),op.getConversion()));
    ...
    private void binarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_binarioActionPerformed
        ...
        if (Pantalla.getText() == ""){
            ...
            op.binario(Pantalla.getText());
            
        }
        op.conversion();
        Pantalla2.setText("BIN");
    }//GEN-LAST:event_binarioActionPerformed

    private void octagonalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_octagonalActionPerformed
        // TODO add your handling code here:
        
        if (Pantalla.getText() == ""){
            op.octagonal();
        }else{
            op.octagonal(Pantalla.getText());
        }
        op.conversion();
        Pantalla2.setText("OCT");
    }//GEN-LAST:event_octagonalActionPerformed

    private void hexagonalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hexagonalActionPerformed
        // TODO add your handling code here:
        if (Pantalla.getText() == ""){
            op.hexagonal();
        }else{
            op.hexagonal(Pantalla.getText());
        }
        
        op.conversion();
        Pantalla2.setText("HEX");
    }//GEN-LAST:event_hexagonalActionPerformed
    ...
    private void decimalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_decimalActionPerformed
        ...
        if (Pantalla.getText() == ""){
            ...
            op.decimal(Pantalla.getText());
        }

        op.conversion();
        Pantalla2.setText("DEC");
